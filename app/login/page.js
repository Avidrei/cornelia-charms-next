    ...
    <div className="mt-[72px] lg:mt-[116px] xl:mt-[128px] flex flex-col lg:grid lg:grid-cols-2 h-screen">
      ...
      <div className="flex flex-col items-center justify-center h-screen overflow-hidden bg-white">
        ...
        <div className="relative flex flex-col items-center justify-center max-w-md ">
          ...
          {/* Background Circle */}
          <div className="absolute lg:-top-[140%] lg:right-[70%] -top-[130%] right-[60%] min-[500px]:-top-[140%]  min-[500px]:right-[100%] xl:-top-[160%] xl:right-[110%] rounded-full w-[450px] h-[450px]  bg-gradient-to-b from-cornelia-softpink to-cornelia-softwhitemix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
          ...
          <form>
            <div className="py-3 mt-3 px-9 md:px-0 md:py-0 xl:mt-9">
              ...
              <input
                ...
                className="w-full p-3 xl:p-4 mb-5 border text-[0.85rem] lg:text-[1rem] xl:text-[1.1rem] border-gray-300 rounded-lg poppins focus:outline-none focus:ring-2 focus:ring-cornelia-darkpink"
              />
              ...
              <button
                type="submit" className="w-full p-2 font-semibold text-white transition-colors duration-300 rounded-lg text-md xl:text-lg lg:p-3 bg-cornelia-softpink poppins hover:bg-cornelia-darkpink">Log In</button>
            </div>
          </form>
        </div>
      </div>
